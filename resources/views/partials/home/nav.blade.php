    ...
    $homeUrl = $isId ? '/id' : '/';
    $cloudUrl = $isId ? '/id/iproc-cloud' : '/iproc-cloud';
    @endphp
    <nav id="navbar" class="px-8 p-6 lg:px-6 py-2.5 fixed top-0 left-0 w-full z-50 bg-transparent">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl w-full">
            <div class="p-2">
                <a href="{{ url($homeUrl) }}" class="">
                    <img loading="lazy" src="/lib/img/Iproc.png" alt="iProc" width="90" height="33">
                </a>
            </div>

            <div class="flex items-center gap-2 lg:gap-4 lg:order-2">
                ...
                <a class="button-nav hidden xl:block" href="http://wa.me/6281315870596">
                    <button type="button" data-i18n="nav.contact"
                        class="bg-primary text-white hover:shadow-inner focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-8 py-2 text-center cursor-pointer">Contact
                        Us</button>
                ...
                <button data-collapse-toggle="menu" type="button" id="menu-btn"
                    class="inline-flex items-center p-2 text-base text-gray-500 rounded-lg  lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 cursor-pointer"
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="menu">
                <ul class="navbar-nav nav flex flex-col mt-4 font-medium lg:flex-row lg:space-x-2 lg:mt-0">
                    <li class="nav-item">
                        <a href="#home" data-i18n="nav.home"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-3 rounded active">Home</a>
                    </li>
                    <li class="nav-item">
                        <a href="#about-us" data-i18n="nav.about"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-3 rounded">About
                            us</a>
                    </li>
                    <li class="nav-item">
                        <a href="#features" data-i18n="nav.features"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-3 rounded">Features</a>
                    </li>
                    <li class="nav-item">
                        <a href="#technology" data-i18n="nav.technology"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-3 rounded">Technology</a>
                    </li>
                    <li class="nav-item">
                        <a href="#customer-story" data-i18n="nav.client"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-3 rounded">Client
                            Story</a>
                    </li>
                    <li class="nav-item">
                        <a href="#blog" data-i18n="nav.blog"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-3 rounded">Blog</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ $cloudUrl }}"
                            class="animate-pulse-scale nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-3 rounded">
                            iProc Cloud<span class="hidden 2xl:inline">:</span>
                            <span class="font-bold hidden 2xl:inline" data-i18n="nav.cloud" data-i18n-html>Plug &amp;
                                Play e-Procurement</span>
                        </a>
                    </li>
                </ul>
            </div>
