    ...
    <nav id="navbar" class="px-8 p-6 lg:px-6 py-2.5 fixed top-0 left-0 w-full z-50 bg-transparent">
        <div class="flex justify-end lg:justify-around items-center mx-auto max-w-screen-2xl w-full">
            <div class="flex items-center space-x-4 lg:space-x-6 order-2 mb-auto ml-0 lg:ml-4!">
                <div id="langPills" class="inline-flex items-center">
                    <!-- EN -->
                    <a id="btnLangEn" href="/iproc-cloud" class="{{ $langBtnBase }} {{ !$isId ? $langBtnActive : $langBtnInactive }}"
                    ...
                    <!-- ID -->
                    <a id="btnLangId" href="/id/iproc-cloud" class="{{ $langBtnBase }} {{ $isId ? $langBtnActive : $langBtnInactive }}"
                ...
                <a class="button-nav hidden xl:block" href="https://wa.me/6285215356968" target="_blank">
                    <button type="button" data-button-id="cta-1" data-button-text="Hubungi Kami Top"
                        class="ga-track-contact bg-primary text-white hover:shadow-inner focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-8 py-2 text-center cursor-pointer hover:bg-[#02519b]"
                        data-i18n="nav.contact">Hubungi
                        Kami</button>
                    <span class="sr-only">Hubungi Kami Button</span>
                </a>
            ...
            <div class="hidden flex-grow justify-between items-center w-full lg:flex lg:w-auto order-1 -mt-4 lg:-mt-0"
                id="menu">
                <ul class="navbar-nav nav flex flex-col mt-4 font-medium lg:flex-row lg:space-x-2 lg:mt-0">
                    <li class="nav-item">
                        <a href="#home"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-2 xl:px-3 rounded active">iProc
                            Cloud<span class="hidden 2xl:inline">:</span>
                            <span class="font-bold hidden 2xl:inline">Plug &amp; Play e-Procurement</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="#problem"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-2 xl:px-3 rounded"
                            data-i18n="cloud.menu.problem">Masalah</a>
                    </li>
                    <li class="nav-item">
                        <a href="#solution"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-2 xl:px-3 rounded"
                            data-i18n="cloud.menu.solution">Solusi</a>
                    </li>
                    <li class="nav-item">
                        <a href="#features"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-2 xl:px-3 rounded"
                            data-i18n="cloud.menu.feature">Fitur
                            Unggulan</a>
                    </li>
                    <li class="nav-item">
                        <a href="#perbandingan"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-2 xl:px-3 rounded"
                            data-i18n="cloud.menu.value">Nilai
                            Investasi</a>
                    </li>
                    <li class="nav-item">
                        <a href="#contact"
                            class="nav-link text-base block text-gray-900 hover:bg-blue-100 w-full py-1.5 px-2 xl:px-3 rounded"
                            data-i18n="cloud.menu.implementation">Informasi
                            Implementasi</a>
                    </li>
                    <li>
                        <a class="button-nav-mini ml-1.5 my-2 hidden" href="https://wa.me/6285215356968"
                            target="_blank">
                            <button type="button"
                                class=" bg-primary text-white hover:shadow-inner focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-base px-8 py-2 text-center cursor-pointer hover:bg-[#02519b]"
                                data-i18n="nav.contact">Hubungi
                                Kami</button>
                            <span class="sr-only">Hubungi Kami Button</span>
                        </a>
