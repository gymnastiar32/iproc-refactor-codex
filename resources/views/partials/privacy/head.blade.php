    @php
        ...
        $pageUrl = $isId ? '/id/iproc-2go/kebijakan-privasi' : '/iproc-2go/privacy-policy';
        $description = __('privacy.meta.description');
        $title = __('privacy.meta.title');
    @endphp
    <meta charset="UTF-8" />
    ...
    <link rel="alternate" hreflang="id" href="{{ url('/id/iproc-2go/kebijakan-privasi') }}" />
    <link rel="alternate" hreflang="en" href="{{ url('/iproc-2go/privacy-policy') }}" />
    <link rel="alternate" hreflang="x-default" href="{{ url('/iproc-2go/privacy-policy') }}" />
